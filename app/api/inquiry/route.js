...
function inquiryText(payload) {
  ...
  return [
    ...
    `Product Page: ${payload.productName || "-"}`,
    `Product Model: ${payload.productModel || "-"}`,
    `Product Family: ${payload.productFamily || "-"}`,
    ...
    `Product Selection Details: ${payload.selectionDetails || "-"}`,
