...
export function createProductFirstNewsDocument({ site, candidate, productMedia, citation }) {
  ...
  const summary = `Review ${brief.productName} for ${brief.application}. Check the product role and site conditions before a configuration discussion.`;
  const document = {
    schemaVersion: 1,
    ...
    cta: { heading: "Send your conveyor and material details", text: "Share material, process position and site conditions for a configuration discussion.", label: "Send your conveyor and material details", href: "/en/request-quote" },
    seo: {
      metaTitle: `${brief.productName} for ${brief.application} | COWIN MAGNET`,
      metaDescription: completeDescription(`Review ${brief.productName} for ${brief.application}. Check site conditions and industry context before a configuration discussion.`),
    ...
    author: { name: `${site.brandName || site.brand_name || "COWIN MAGNET"} Editorial Team`, profilePath: "/editorial-policy", role: "Editorial Team" }
  };
