...
export const blogPosts = [
  {
    "slug": "wet-drum-magnetic-separator-iron-ore-processing-brazil",
    "title": "Wet Drum Magnetic Separator for Iron Ore Processing in Brazil",
    "seoTitle": "Wet Drum Magnetic Separator for Iron Ore Processing in Brazil",
    "metaDescription": "Learn how Brazilian iron ore buyers choose wet drum magnetic separators by ore type, slurry density, particle size, capacity, tank type and process goal.",
    "h1": "Wet Drum Magnetic Separator for Iron Ore Processing in Brazil",
    "category": "Regional Application",
    "keywords": [
      "wet drum magnetic separator",
      "iron ore magnetic separation",
      "Brazil iron ore processing equipment",
      "CTB wet drum magnetic separator"
    ],
    "excerpt": "Brazilian iron ore buyers often ask which wet drum magnetic separator is suitable for beneficiation, roughing, cleaning or tailings recovery. The practical answer depends on ore magnetism, particle size, slurry concentration, capacity, tank structure and process goal.",
    "readingTime": 9,
...
| Type | Typical Selection Logic | Buyer Question |
|---|---|---|
| CTB semi-countercurrent | Often used in many magnetite separation and concentration duties | Do I need a balanced option for recovery and concentrate quality? |
| CTN countercurrent | Often considered where recovery from finer magnetic material is important | Is the feed fine enough and suitable for this flow pattern? |
| CTS co-current | Often used where slurry and magnetic product movement match a specific process requirement | Does my flowsheet require this discharge and flow arrangement? |
...
|---|---|
| Ore type and mineral composition | Determines whether wet magnetic separation is suitable |
| Feed particle size | Affects liberation and separation performance |
| Slurry concentration | Influences flow, capture and discharge behavior |
| Feed capacity | Determines drum size and quantity |
| Process duty | Roughing, cleaning, scavenging and concentration require different priorities |
| Required concentrate goal | Helps evaluate whether magnetic separation alone is enough |
| Water condition | Affects slurry handling, wear and maintenance |
| Existing flow sheet | Shows where the separator will be installed |
| Installation space | Determines layout and maintenance access |
| Power and site conditions | Helps confirm motor, controls and export configuration |
...
Send your ore type, feed particle size, slurry concentration, capacity and flow sheet to COWIN MAGNET for practical wet drum magnetic separator selection support before quotation.`
  },
  {
    ...
    "title": "How to Choose an Overband Magnetic Separator for Conveyor Belt Systems",
    "seoTitle": "How to Choose an Overband Magnetic Separator for Conveyor Belts",
    "metaDescription": "Learn how to choose an overband magnetic separator by belt width, belt speed, material layer, suspension height, iron contamination, and installation method.",
    "h1": "How to Choose an Overband Magnetic Separator for Conveyor Belt Systems",
    ...
    "excerpt": "Choosing an overband magnetic separator is not only a question of magnetic force. In real conveyor belt systems, the right choice depends on the material being conveyed, the thickness of the material layer, the belt width, the bel",
    "readingTime": 8,
    "publishedAt": "2026-05-28",
    "updatedAt": "2026-05-28",
    "image": "/images/generated/home-hero-cowinmagnet.webp",
  ...
  },
  {
    ...
    "title": "Permanent vs Electromagnetic Separator: Which One Is Better for Your Conveyor Line?",
    "seoTitle": "Permanent vs Electromagnetic Separator: Conveyor Selection Guide",
    "metaDescription": "Compare permanent and electromagnetic separators for conveyor belts. Learn when to choose each option based on material burden, iron contamination, power, maintenance, and cost.",
    "h1": "Permanent vs Electromagnetic Separator: Which One Is Better for Your Conveyor Line?",
